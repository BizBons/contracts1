                    ...
                    <tbody id="cTable">
                      <?php
                        ...
                        while($row = mysqli_fetch_array($result)){
                            ...
                            <tr>
                              <td>".$row['username']."</td>
                              <td>".strtoupper($row['user_fname']).' '.strtoupper($row['user_reg']).' '.strtoupper($row['user_lname'])."</td>
                    ...
                    <tbody id='sTable'>
                      <?php
                        ...
                        <tr>
                          ...
                          <td>".strtoupper($row['student_fname']).' '.strtoupper($row['student_reg']).' '.strtoupper($row['student_lname'])."</td>
              ...
              <div class="row">
                <div class="col-xs-12">
                  ...
                  <?php
                    ...
                    $tot_pres = mysqli_query($conn,$count_total_pres);
                    if($tot_pres === FALSE)
                      die(mysqli_error());
                    else{
                      $tot_pres = mysqli_fetch_row($tot_pres);
                    ...
                    $total_pres = mysqli_query($conn,$count_vote_pres);
                    while($row = mysqli_fetch_array($total_pres))
                    {
                ...
                <div class="col-xs-12">
                  ...
                  <?php
                    ...
                    $count_total_vpres = "SELECT v.position_id, COUNT(*) as total_vote
                                        ...
                                        GROUP BY v.position_id";
                    $tot_vpres = mysqli_query($conn,$count_total_vpres);
                    if($tot_vpres === FALSE)
                      die(mysqli_error());
                    else{
                      $tot_vpres = mysqli_fetch_row($tot_vpres);
                    ...
                    $count_vote_vpres = "SELECT a.candidate_id, b.candidate_picture, b.candidate_name, c.party_name, b.candidate_position_id
                                        ...
                                        GROUP BY a.candidate_id";
                    $total_vpres = mysqli_query($conn,$count_vote_vpres);
                    while($row = mysqli_fetch_array($total_vpres))
                    {
                ...
                <div class="col-xs-12">
                  ...
                  <?php
                    ...
                    $count_total_sec = "SELECT v.position_id, COUNT(*) as total_vote
                                        ...
                                        GROUP BY v.position_id";
                    $tot_sec = mysqli_query($conn,$count_total_sec);
                    if($tot_sec === FALSE)
                      die(mysqli_error());
                    else{
                      $tot_sec = mysqli_fetch_row($tot_sec);
                    ...
                    $count_vote_sec = "SELECT a.candidate_id, b.candidate_picture, b.candidate_name, c.party_name, b.candidate_position_id
                                        ...
                                        GROUP BY a.candidate_id";
                    $total_sec = mysqli_query($conn,$count_vote_sec);
                    while($row = mysqli_fetch_array($total_sec))
                    {
                ...
                <div class="col-xs-12">
                  ...
                  <?php
                    ...
                    $count_total_treas = "SELECT v.position_id, COUNT(*) as total_vote
                                        ...
                                        GROUP BY v.position_id";
                    $tot_treas = mysqli_query($conn,$count_total_treas);
                    if($tot_treas === FALSE)
                      die(mysqli_error());
                    else{
                      $tot_treas = mysqli_fetch_row($tot_treas);
                    ...
                    $count_vote_treas = "SELECT a.candidate_id, b.candidate_picture, b.candidate_name, c.party_name, b.candidate_position_id
                                        ...
                                        GROUP BY a.candidate_id";
                    $total_treas = mysqli_query($conn,$count_vote_treas);
                    while($row = mysqli_fetch_array($total_treas))
                    {
                ...
                <div class="col-xs-12">
                  ...
                  <?php
                    ...
                    $count_total_fourth = "SELECT v.position_id, COUNT(*) as total_vote
                                        ...
                                        GROUP BY v.position_id";
                    $tot_fourth = mysqli_query($conn,$count_total_fourth);
                   if($tot_fourth === FALSE)
                      die(mysqli_error());
                    else{
                      $tot_fourth = mysqli_fetch_row($tot_fourth);
                    ...
                    $count_vote_fourth = "SELECT a.candidate_id, b.candidate_picture, b.candidate_name, c.party_name, b.candidate_position_id
                                        ...
                                        GROUP BY a.candidate_id";
                    $total_fourth = mysqli_query($conn,$count_vote_fourth);
                    while($row = mysqli_fetch_array($total_fourth))
                    {
                ...
                <div class="col-xs-12">
                  ...
                  <?php
                    ...
                    $count_total_third = "SELECT v.position_id, COUNT(*) as total_vote
                                        ...
                                        GROUP BY v.position_id";
                    $tot_third = mysqli_query($conn,$count_total_third);
                   if($tot_third === FALSE)
                      die(mysqli_error());
                    else{
                      $tot_third = mysqli_fetch_row($tot_third);
                    ...
                    $count_vote_third = "SELECT a.candidate_id, b.candidate_picture, b.candidate_name, c.party_name, b.candidate_position_id
                                        ...
                                        GROUP BY a.candidate_id";
                    $total_third = mysqli_query($conn,$count_vote_third);
                    while($row = mysqli_fetch_array($total_third))
                    {
                ...
                <div class="col-xs-12">
                  ...
                  <?php
                    ...
                    $count_total_second = "SELECT v.position_id, COUNT(*) as total_vote
                                        ...
                                        GROUP BY v.position_id";
                    $tot_second = mysqli_query($conn,$count_total_second);
                   if($tot_second === FALSE)
                      die(mysqli_error());
                    else{
                      $tot_second = mysqli_fetch_row($tot_second);
                    ...
                    $count_vote_second = "SELECT a.candidate_id, b.candidate_picture, b.candidate_name, c.party_name, b.candidate_position_id
                                        ...
                                        GROUP BY a.candidate_id";
                    $total_second = mysqli_query($conn,$count_vote_second);
                    while($row = mysqli_fetch_array($total_second))
                    {
                ...
                <div class="col-xs-12">
                  ...
                  <?php
                    ...
                    $count_total_first = "SELECT v.position_id, COUNT(*) as total_vote
                                        ...
                                        GROUP BY v.position_id";
                    $tot_first = mysqli_query($conn,$count_total_first);
                   if($tot_first === FALSE)
                      die(mysqli_error());
                    else{
                      $tot_first = mysqli_fetch_row($tot_first);
                    ...
                    $count_vote_first = "SELECT a.candidate_id, b.candidate_picture, b.candidate_name, c.party_name, b.candidate_position_id
                                        ...
                                        GROUP BY a.candidate_id";
                    $total_first = mysqli_query($conn,$count_vote_first);
                    while($row = mysqli_fetch_array($total_first))
                    {
        ...
        $('#updateElectionBtn').click(function(){
          $('#formEditElection').ajaxSubmit({
              ...
              success: function (response) { console.log(response);
                ...
                {
                  //alert("Upload Failed! mysqli_query($conn, wrong!");
                  $('#messageModal').find('p').html("<h2 class='heading text-center'>mysqli_query($conn, wrong. Please contact your technical team</h2>");
                  $('#messageModal').modal("show");
                }
              }
          });
