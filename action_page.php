...
<?php
    ...
    $query = "SELECT * FROM users a left join voter_election b on a.username=b.username WHERE a.email = '".$username."' AND a.password = '".$password."' LIMIT 1;";
    ...
    if (mysqli_num_rows($result) > 0)
    {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            $_SESSION['mi'] = strtoupper($row['user_reg']);
