 ...
 print_r($_FILES);
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES["partylogo"])) {
      ...
      $party_result = mysqli_query($conn,$update_party);
      if(!$party_result) 
        $error = 'true';
    }
    else
    ...
    if(trim($pres_name) != "")
    {
      ...
      if (isset($_FILES["pres_pic"])) {
        ...
        if($pres_id != '')
        {
          ...
          $pres_result = mysqli_query($conn,$update_pres);
          if(!$pres_result)
            $error = 'true';        
        }
      }
      ...
      if($pres_id == '')
      {
        ...
        $pres_result = mysqli_query($conn,$insert_pres);
        if(!$pres_result)
          $error = 'true';
      }
    ...
    if(trim($vpres_name) != "")
    {
      ...
      if (isset($_FILES["vpres_pic"])) {
        ...
        if($vpres_id != '')
        {
          ...
          $vpres_result = mysqli_query($conn,$update_vpres);
          if(!$vpres_result)
            $error = 'true';
        }   
      }
      ...
      if($vpres_id == '')
      {
        ...
        $vpres_result = mysqli_query($conn,$insert_vpres);
        if(!$vpres_result)
          $error = 'true';
      }
    ...
    if(trim($sec_name) != "")
    {
      ...
      if (isset($_FILES["sec_pic"])) {
        ...
        if($sec_id != '')
        {
          ...
          $sec_result = mysqli_query($conn,$update_sec);
          if(!$sec_result)
            $error = 'true';
        }
      }
      ...
      if($sec_id == '')
      {
        ...
        $sec_result = mysqli_query($conn,$insert_sec);
        if(!$sec_result)
          $error = 'true';
      }
    }
    ...
    if(trim($treas_name) != "")
    {
      ...
      if (isset($_FILES["treas_pic"])) {
        ...
        if($treas_id != '')
        {
          ...
          $treas_result = mysqli_query($conn,$update_treas);
          if(!$treas_result)
            $error = 'true';
        }
      }
      ...
      if($treas_id == '')
      {
        ...
        $treas_result = mysqli_query($conn,$insert_treas);
        if(!$treas_result)
          $error = 'true';
      }
    ...
    if(trim($firstRep_name) != "")
    {
      ...
      if (isset($_FILES["firstRep_pic"])) {
        ...
        if($firstRep_id != '')
        {
          ...
          $firstRep_result = mysqli_query($conn,$update_firstRep);
          if(!$firstRep_result)
            $error = 'true';
        }
      }
      ...
      if($firstRep_id == '')
      {
        ...
        $firstRep_result = mysqli_query($conn,$insert_firstRep);
        if(!$firstRep_result)
          $error = 'true';
      }
    }
    ...
    if(trim($secondRep_name) != "")
    {
      ...
      if (isset($_FILES["secondRep_pic"])) {
        ...
        if($secondRep_id != '')
        {
          ...
          $secondRep_result = mysqli_query($conn,$update_secondRep);
          if(!$secondRep_result)
            $error = 'true';
        }
      }
      ...
      if($secondRep_id == '')
      {
        ...
        $secondRep_result = mysqli_query($conn,$insert_secondRep);
        if(!$secondRep_result)
          $error = 'true';
      }
    ...
    if(trim($thirdRep_name) != "")
    {
      ...
      if (isset($_FILES["thirdRep_pic"])) {
        ...
        if($thirdRep_id != '')
        {
          ...
          $thirdRep_result = mysqli_query($conn,$update_thirdRep);
          if(!$thirdRep_result)
            $error = 'true';
        }
      }
      ...
      if($thirdRep_id == '')
      {
        ...
        $thirdRep_result = mysqli_query($conn,$insert_thirdRep);
        if(!$thirdRep_result)
          $error = 'true';
      }
    ...
    if(trim($fourthRep_name) != "")
    {
      ...
      if (isset($_FILES["fourthRep_pic"])) {
        ...
        if($fourthRep_id != '')
        {
          ...
          $fourthRep_result = mysqli_query($conn,$update_fourthRep);
          if(!$fourthRep_result)
            $error = 'true';
        }
      }
      ...
      if($fourthRep_id == '')
      {
        ...
        $fourthRep_result = mysqli_query($conn,$insert_fourthRep);
        if(!$fourthRep_result)
          $error = 'true';
      }
